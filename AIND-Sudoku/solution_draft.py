        ...
        for box in doubles:
            ...
            for el in doubles:
                ...
                if box != el and values[box] == values[el]:
                    #print("box=", box, values[box], "el=", el, values[el])
                    
                    for unit in unitlist:
                        if el in unit and box in unit:
                            for bx in unit:
                                for digit in values[box]:
                                    if digit in values[bx] and bx != el and bx !=box:
                                        #print("box=", box, values[box], "el=", el, values[el])
                                        #print("value bx=", bx, values[bx])
...
def reduce_puzzle(values):
    ...
    while not stalled:
        ...
        #print("after only choice") #DELETE
        #display(values) ##DELETE
