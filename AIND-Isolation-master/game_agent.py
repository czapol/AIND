...
def custom_score_2(game, player):
    ...
    return float(1/((xo-xp)**2+(yo+yp)**2))
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def terminal_test(self, game, depth):
        ...
        #return True if no more legal moves i.e. not bool([])=True
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        best_move=max(game.get_legal_moves(), key=lambda m: self.min_value(game.forecast_move(m),depth-1))
        '''    
        return best_move
        
        #return game.get_legal_moves() - to test point (1)
